  ...
  return (
    <section className="h-[calc(100vh-60px)] text-white flex items-center justify-center">
      ...
      <div className="text-center flex flex-col justify-center gap-4 h-[90%]">
        ...
        <button
          type="button"
          className="w-50 mt-20 mx-auto text-lg md:text-xl lg:text-2xl text-white transition-all duration-300 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-3 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center cursor-pointer hover:scale-110"
        >
          Book Now
        </button>
      </div>
