import AkLogo from '../../assets/aktechtbg.webp';
      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 flex items-center">
            <img src={AkLogo} className="h-12 me-3" alt="Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap">AK Travels</span>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-500 font-medium">
                ...
                <li>
                  <a href="#sevices" className="hover:underline">
                    Services
                  </a>
                </li>
              </ul>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">© 2025 AK Travels™. All Rights Reserved.</span>
